...
## Build 0.9.1.2.1 — Ressenti uniquement
Modification volontairement isolée :
- Ouvrir Ressenti recharge la fiche du jour si elle existe.
- Modifier affiche les valeurs réellement enregistrées (sommeil, énergie, stress, faim, poids, tour de taille).
- Enregistrer met à jour la même fiche datée.
- Un champ poids/tour de taille laissé vide lors d'une modification ne supprime pas une valeur déjà enregistrée.
Aucun changement Évolution, Alimentation, Photos, Strava, Force, IA, service worker ou cache.
