const CACHE='fluidite-force-step1-isolated';
const ASSETS=['./','./index.html','./styles.css','./app.js','./db.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./force-detail-step1.js','./force-detail-step1.css'];
