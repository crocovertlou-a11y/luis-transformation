const CACHE='fluidite-v2112-companion-recipes-action';
const ASSETS=['./','./index.html','./styles.css?v=v2112','./app.js?v=v2112','./db.js?v=v211','./manifest.webmanifest','./icon-192.png','./icon-512.png','./force-detail-step1.js','./force-detail-step1.css','./nutrition-resilience.js'];
