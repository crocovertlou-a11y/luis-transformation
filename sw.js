const CACHE='fluidite-v2111-companion-recipes';
const ASSETS=['./','./index.html','./styles.css?v=v2111','./app.js?v=v2111','./db.js?v=v211','./manifest.webmanifest','./icon-192.png','./icon-512.png','./force-detail-step1.js','./force-detail-step1.css','./nutrition-resilience.js'];
