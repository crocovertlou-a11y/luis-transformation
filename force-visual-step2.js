...
(() => {
  ...
  const LIBRARY_ASSETS={
    bench:{card:'force-card-developpe-couche.webp',thumb:'force-thumb-developpe-couche.webp'},
    pullup:{card:'force-card-tractions.webp',thumb:'force-thumb-tractions.webp'},
    row:{card:'force-card-rowing-barre.webp',thumb:'force-thumb-rowing-barre.webp'},
    shoulder:{card:'force-card-developpe-epaules.webp',thumb:'force-thumb-developpe-epaules.webp'},
    lateral:{card:'force-card-elevations-laterales.webp',thumb:'force-thumb-elevations-laterales.webp'},
    facepull:{card:'force-card-face-pull.webp',thumb:'force-thumb-face-pull.webp'},
    curl:{card:'force-card-curl-biceps.webp',thumb:'force-thumb-curl-biceps.webp'},
    triceps:{card:'force-card-extensions-triceps.webp',thumb:'force-thumb-extensions-triceps.webp'},
    squat:{card:'force-card-squat.webp',thumb:'force-thumb-squat.webp'},
    lunge:{card:'force-card-fentes.webp',thumb:'force-thumb-fentes.webp'},
    rdl:{card:'force-card-souleve-terre-roumain.webp',thumb:'force-thumb-souleve-terre-roumain.webp'},
    calf:{card:'force-card-mollets.webp',thumb:'force-thumb-mollets.webp'},
    plank:{card:'force-card-gainage.webp',thumb:'force-thumb-gainage.webp'}
  };
  const extraAssetForName=name=>{
    const s=String(name||'').toLowerCase();
    if(s.includes('incliné')||s.includes('incline')) return {card:'force-card-developpe-incline.webp',thumb:'force-thumb-developpe-incline.webp'};
    if(s.includes('dips')) return {card:'force-card-dips.webp',thumb:'force-thumb-dips.webp'};
